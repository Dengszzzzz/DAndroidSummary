...
public class DownloadRetrofitUtils {
    ...
    private String baseUrl="http://admin123.pplussport.com/";
    ...
    public void downloadFile(final long range, final String url, final String fileName,
        ...
        String unDownloadRangStr = "bytes=" + Long.toString(range) + "-" + totalLength;
                ...
                .subscribe(new Observer<ResponseBody>() {
                    ...
                    public void onNext(ResponseBody responseBody) {
                        ...
                        try {
                            ...
                            KLog.d("DownloadIntentService", e.getMessage());
