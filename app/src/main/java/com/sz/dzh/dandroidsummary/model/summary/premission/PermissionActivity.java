...
public class PermissionActivity extends BaseActivity {
    ...
    private void applyPremission() {
        PermissionsUtils.getInstance().checkPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE
                , Manifest.permission.READ_EXTERNAL_STORAGE}, new PermissionsUtils.IPermissionsResult() {
            @Override
            public void accept() {
                //
            }
            ...
            @Override
            public void forbit() {
                ToastUtils.showToast("您已拒绝sd卡读写权限");
            }
        });
    }
