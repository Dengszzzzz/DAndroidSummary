...
import com.sz.dzh.dandroidsummary.model.specialFunc.crop.handler.CatchEdgeUtil;
import com.sz.dzh.dandroidsummary.model.specialFunc.crop.handler.CropWindowEdgeSelector;
import com.sz.dzh.dandroidsummary.model.specialFunc.crop.handler.Edge;
import com.sz.dzh.dandroidsummary.model.specialFunc.crop.handler.UIUtil;
...
public class CropImageView extends AppCompatImageView {
    ...
    public Bitmap getCroppedImage() {
        ...
        float bitmapLeft = (transX > 0) ? -transX : 0;
        float bitmapTop = (transY > 0) ? -transY : 0;
