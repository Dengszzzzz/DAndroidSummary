...
public class RxConditionActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rx_ac_condition);
        ButterKnife.bind(this);
        initTitle();
        tvTitle.setText("条件/布尔操作符");
    }

    @OnClick({R2.id.btn_all, R2.id.btn_takeWhile, R2.id.btn_skipWhile, R2.id.btn_takeUntil, R2.id.btn_skipUntil, R2.id.btn_sequenceEqual, R2.id.btn_contains, R2.id.btn_amb, R2.id.btn_defaultEmpty})
    public void onViewClicked(View view) {
        int i = view.getId();
        if (i == R.id.btn_all) {
            all();
        } else if (i == R.id.btn_takeWhile) {
            takeWhile();
        } else if (i == R.id.btn_skipWhile) {
            skipWhile();
        } else if (i == R.id.btn_takeUntil) {
            takeUntil();
        } else if (i == R.id.btn_skipUntil) {
            skipUntil();
        } else if (i == R.id.btn_sequenceEqual) {
            sequenceEqual();
        } else if (i == R.id.btn_contains) {
            contains();
        } else if (i == R.id.btn_amb) {
            amb();
        } else if (i == R.id.btn_defaultEmpty) {
            defaultEmpty();
        }
    }
