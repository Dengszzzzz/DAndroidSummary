package com.sz.dengzh.drxjavasummary.module.rxStudy;
...
public class RxFilterActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rx_ac_filter);
        ButterKnife.bind(this);
        initTitle();
        tvTitle.setText("过滤操作符");
    }

    @OnClick({R2.id.btn_filter, R2.id.btn_ofType, R2.id.btn_skip, R2.id.btn_skipLast, R2.id.btn_distinct,
            R2.id.btn_distinctUntilChanged, R2.id.btn_take, R2.id.btn_takeLast,R2.id.btn_throttleFirst, R2.id.btn_debounce})
    public void onViewClicked(View view) {
        int i = view.getId();
        if (i == R.id.btn_filter) {
            filter();
        } else if (i == R.id.btn_ofType) {
            ofType();
        } else if (i == R.id.btn_skip) {
            skip();
        } else if (i == R.id.btn_skipLast) {
            skipLast();
        } else if (i == R.id.btn_distinct) {
            distinct();
        } else if (i == R.id.btn_distinctUntilChanged) {
            distinctUntilChanged();
        } else if (i == R.id.btn_take) {
            take();
        } else if (i == R.id.btn_takeLast) {
            takeLast();
        } else if (i == R.id.btn_throttleFirst) {
            throttleFirst();
        } else if (i == R.id.btn_debounce) {
            debounce();
        }
    }
