...
public class RxFunctionActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rx_ac_function);
        ButterKnife.bind(this);
        initTitle();
        tvTitle.setText("功能性操作符");
    }

    @OnClick({R2.id.btn_do, R2.id.btn_retry, R2.id.btn_retryUntil, R2.id.btn_retryWhen, R2.id.btn_repeat, R2.id.btn_repeatWhen})
