...
public class RxCombineActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rx_ac_combine);
        ButterKnife.bind(this);
        initTitle();
        tvTitle.setText("组合 / 合并操作符");
    }

    @OnClick({R2.id.btn_concat, R2.id.btn_merge, R2.id.btn_concatDelayError, R2.id.btn_zip, R2.id.btn_combineLatest, R2.id.btn_reduce, R2.id.btn_collect, R2.id.btn_startWith, R2.id.btn_count})
    public void onViewClicked(View view) {
        int i = view.getId();
        if (i == R.id.btn_concat) {
            concat();
        } else if (i == R.id.btn_merge) {
            merge();
        } else if (i == R.id.btn_concatDelayError) {
            concatDelayError();
        } else if (i == R.id.btn_zip) {
            zip();
        } else if (i == R.id.btn_combineLatest) {
            combineLatest();
        } else if (i == R.id.btn_reduce) {
            reduce();
        } else if (i == R.id.btn_collect) {
            collect();
        } else if (i == R.id.btn_startWith) {
            startWith();
