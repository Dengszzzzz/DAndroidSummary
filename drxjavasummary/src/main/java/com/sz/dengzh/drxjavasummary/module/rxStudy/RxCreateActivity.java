...
public class RxCreateActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rx_ac_create);
        ButterKnife.bind(this);
        initTitle();
        tvTitle.setText("创建操作符");
    }

    @OnClick({R2.id.btn_create, R2.id.btn_just, R2.id.btn_fromArray, R2.id.btn_fromIterable, R2.id.btn_defer, R2.id.btn_timer, R2.id.btn_interval, R2.id.btn_intervalRange, R2.id.btn_range})
    public void onViewClicked(View view) {
        int i = view.getId();
        if (i == R.id.btn_create) {
            create();
        } else if (i == R.id.btn_just) {
            just();
        } else if (i == R.id.btn_fromArray) {
            fromArray();
        } else if (i == R.id.btn_fromIterable) {
            fromIterable();
        } else if (i == R.id.btn_defer) {
            defer();
        } else if (i == R.id.btn_timer) {
            timer();
        } else if (i == R.id.btn_interval) {
            interval();
        } else if (i == R.id.btn_intervalRange) {
            intervalRange();
        } else if (i == R.id.btn_range) {
            range();
        }
    }
